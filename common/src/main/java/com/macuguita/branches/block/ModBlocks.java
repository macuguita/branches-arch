...
public class ModBlocks {
    ...
    public static <T extends Block> RegistrySupplier<T> registerWithItem(String name, Supplier<T> block) {
        return RegUtils.registerWithItem(BLOCKS, BLOCK_REGISTRAR, ITEMS, ITEM_REGISTRAR, Identifier.of(MOD_ID, name), block);
    }

    public static <T extends Block> RegistrySupplier<T> registerWithoutItem(String path, Supplier<T> block) {
        return RegUtils.registerWithoutItem(BLOCKS, BLOCK_REGISTRAR, Identifier.of(MOD_ID, path), block);
    }

    public static <T extends Item> RegistrySupplier<T> registerItem(String path, Supplier<T> itemSupplier) {
        return RegUtils.registerItem(ITEMS, ITEM_REGISTRAR, Identifier.of(MOD_ID, path), itemSupplier);
    }
}
